...
const ProductList = () => {
  ...
  return (
    <div className="product-list">
      ...
      <FilterBar className="filterbar-class" onSearch={handleSearch} isDisabled={selectedRowIds.size > 0 || showDeleteConfirm} onReset={handleResetFilters} />
      ...
      {showDeleteConfirm && (
        <>
          <div className="overlay" onClick={handleDeleteCancel}></div> {/* Overlay */}
